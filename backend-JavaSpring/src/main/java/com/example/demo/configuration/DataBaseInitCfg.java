...
public class DataBaseInitCfg {
    ...
    private void addOffers() {
        ...
        subcategories.forEach(
                (subcategory -> {
                    this.offerRepository.save(new Offer("Example offer", "Example description", random.nextInt(300)+1, random.nextInt(5)+1, random.nextInt(2)+1, fileEntity,subcategory, (long) random.nextInt(3)+1));
                }));
    }
